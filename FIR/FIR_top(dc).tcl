...
#########################################
set top_level FIR_top
source -verbose "../common_script/common.tcl"
read_verilog "../../qsim_rtl/$top_level/$top_level.v"
read_verilog  "../../qsim_rtl/FIR_top/FIR_top.v"
read_verilog  "../../qsim_rtl/shift_reg/shift_reg.v"
read_verilog  "../../qsim_rtl/CMEM/CMEM.v"
read_verilog  "../../qsim_rtl/FSM/FSM.v" 
read_verilog  "../../qsim_rtl/ALU/ALU.v"
read_verilog  "../../qsim_rtl/CDC_FIFO/CDC_FIFO.v" 
