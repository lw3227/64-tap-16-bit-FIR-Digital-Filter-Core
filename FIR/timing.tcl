...
# Setting variables 
set clk_period 500.00
set clk_period_w 50000.00
...
if {[sizeof_collection [get_ports clk1]] > 0} {
  ...
  set clk_port_w "clk1"
  #If no waveform is specified, 50% duty cycle is assumed
  create_clock -name $clk_name_w -period $clk_period_w [get_ports $clk_port_w] 
  set_drive 0 [get_clocks $clk_name_w] 
}
...
#Set clock uncertainty
set_clock_uncertainty $clk_uncertainty [get_clocks $clk_name_w]
#Propagated clock used for gated clocks only
set_clock_transition $clk_transition [get_clocks $clk_name_w]

# Configure the clock network
#set_fix_hold [all_clocks] 
#set_dont_touch_network $clk_port 
#set_ideal_network $clk_port 
#set_dont_touch_network $clk_port_w 
#set_ideal_network $clk_port_w 
...
set_input_delay $typical_input_delay [all_inputs] -clock $clk_name_w 
remove_input_delay -clock $clk_name_w [find port $clk_port_w]
set_output_delay $typical_output_delay [all_outputs] -clock $clk_name_w  
